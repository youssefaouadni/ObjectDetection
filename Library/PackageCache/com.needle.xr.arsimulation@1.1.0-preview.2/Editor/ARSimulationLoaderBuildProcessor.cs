...
namespace Needle.XR.ARSimulation
{
    ...
    /// ARSimulation Loader at runtime.
    ///
    ...
    /// </summary>
    public class ARSimulationLoaderBuildProcessor : IPreprocessBuildWithReport, IPostprocessBuildWithReport
    {
        ...
        static void CleanOldSettings()
        {
            ...
            var oldSettings = from s in preloadedAssets
                where s != null && s.GetType() == typeof(ARSimulationLoaderSettings)
                select s;
        ...
        public void OnPreprocessBuild(BuildReport report)
        {
            ...
            EditorBuildSettings.TryGetConfigObject(ARSimulationLoaderConstants.k_SettingsKey, out settings);
            if (settings == null)
                return;
